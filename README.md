...
![Horizontal stepper](https://axthebaldi.github.io/mdl-stepper/assets/svg/stepper-horizontal.svg)
...
[axthebaldi.github.io/mdl-stepper](https://axthebaldi.github.io/mdl-stepper/)
...
You can [download](https://github.com/axthebaldi/mdl-stepper/archive/master.zip) the current version of repository compacted.

### Build

```bash
# Clone the repository.
git clone git@github.com:axthebaldi/mdl-stepper.git
...
See component [markup details](https://axthebaldi.github.io/mdl-stepper/component/index.html).
...
[MIT License](https://github.com/axthebaldi/mdl-stepper/blob/gh-pages/LICENSE) © 2016 Alexandre Thebaldi

> FYI: The stars are gone because this repo went private for a moment.